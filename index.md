...
venue: "Stockholm Trio Online Workshop: R, Shell & Git"        # brief name of host site without address (e.g., "Euphoric State University")
...
language: "English"     # lowercase two-letter ISO language code Fsuch as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes)
...
<p id="registration">
  <strong>Registration:</strong> <a href='https://kib.ki.se/en/node/62105/register'>Registration form (open to affiliates of KTH, KI & SU)</a>
</p>  
